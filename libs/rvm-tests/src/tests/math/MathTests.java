...
public class MathTests {
	...
	public static long rem(long left, long right) {
		return left % right;
	}
	...
	public static float neg(float value) {
		return -value;
	}
	...
	public static long shl(long left, long right) {
		return left << right;
	}

	public static int shr(int left, int right) {
		return left >> right;
	}

	public static long shr(long left, long right) {
		return left >> right;
	}

	public static int ushr(int left, int right) {
		return left >>> right;
	}

	public static long ushr(long left, long right) {
		return left >>> right;
	}
