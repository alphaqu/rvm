...
use crate::object::{MethodCode, Type, Value};
use crate::reader::{BaseDesc, BinaryName, Code, ConstantInfo};
use crate::{
    Class, ClassConst, ClassKind, JError, JResult, Method, Object, Ref, Runtime, StrParse,
    ValueDesc,
};
...
impl<'a> Frame<'a> {
    ...
    pub fn execute(mut self, runtime: &Runtime, method_id: Id<Method>) -> JResult<Option<StackValue>> {
