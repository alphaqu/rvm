...
impl ValueDesc {
    ...
    pub fn ty(&self) -> ValueType {
        match self {
            ...
            ValueDesc::Array(_) | ValueDesc::Object(_) => {
                ValueType::Reference
            }
        }
    }
...
mod tests {
    ...
    fn parse_primitives() {
        ...
        assert_eq!(ValueDesc::parse("D"), Some(ValueDesc::Base(BaseDesc::Double)));
        assert_eq!(ValueDesc::parse("F"), Some(ValueDesc::Base(BaseDesc::Float)));
        ...
        assert_eq!(ValueDesc::parse("S"), Some(ValueDesc::Base(BaseDesc::Short)));
        assert_eq!(ValueDesc::parse("Z"), Some(ValueDesc::Base(BaseDesc::Boolean)));
    }
